...
export const appendHeading = workflow({
	name: "appendHeading",
	entrypoint: {
		instructions: `Use when a Markdown outline needs one additional empty
section before further processing. Appends the requested level-two heading
and passes the revised outline to your continuation; does not write section
content or assess the result.`,
	},
	args: Type.Object({
